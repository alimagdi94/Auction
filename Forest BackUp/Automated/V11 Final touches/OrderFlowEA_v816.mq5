//+------------------------------------------------------------------+
//|  OrderFlowEA_v816.mq5                                            |
//|  Order Flow EA — Production Grade v8.16                          |
//|                                                                    |
//|  v8.16 — March 2026 code-review patch (4 fixes applied).        |
...
#property description "Order Flow EA v8.16 — Production-Grade (Code Review Fixes Applied)"
#property strict

// [V8-18] Single source of truth for the EA version string.
#define EA_VERSION "8.16"
