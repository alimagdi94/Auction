...
//+------------------------------------------------------------------+
//| Cache broker/symbol info into globals (call on init + new bar)   |
//+------------------------------------------------------------------+
...
int OnInit()
  {
   ...
   trade.SetDeviationInPoints(20);   // 2 pip slippage allowance
   ...
   Print(StringFormat("FootprintEA v6 initialised — Symbol:%s  Magic:%d  Pip:%.5f  VolStep:%.2f  TickVal:%.4f",
