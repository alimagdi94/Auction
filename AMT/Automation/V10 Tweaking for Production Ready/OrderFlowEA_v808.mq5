//+------------------------------------------------------------------+
//|  OrderFlowEA_v808.mq5                                            |
//|  Order Flow EA — Production Grade v8.08                          |
//|                                                                    |
//|  v8.08 — March 2026 code-review patch (9 fixes applied).        |
//|  All v8.07 logic preserved; this release addresses:              |
//|                                                                    |
...
#property version     "8.08"
#property description "Order Flow EA v8.08 — Production-Grade (Code Review Fixes Applied)"
#property strict

// [V8-18] Single source of truth for the EA version string.
#define EA_VERSION "8.08"
