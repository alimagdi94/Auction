//+------------------------------------------------------------------+
//|  OrderFlowEA_v807.mq5                                            |
//|  Order Flow EA — Production Grade v8.07                          |
//|                                                                    |
//|  v8.07 — March 2026 code-review patch (8 fixes applied).        |
//|  All v8.06 logic preserved; this release addresses:              |
//|                                                                    |
...
#property version     "8.07"
#property description "Order Flow EA v8.07 — Production-Grade (Code Review Fixes Applied)"
#property strict

// [V8-18] Single source of truth for the EA version string.
#define EA_VERSION "8.07"
