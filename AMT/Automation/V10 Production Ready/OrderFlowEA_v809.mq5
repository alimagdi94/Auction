//+------------------------------------------------------------------+
//|  OrderFlowEA_v809.mq5                                            |
//|  Order Flow EA — Production Grade v8.09                          |
//|                                                                    |
//|  v8.09 — March 2026 code-review patch (4 fixes applied).        |
//|  All v8.08 logic preserved; this release addresses:              |
//|                                                                    |
...
#property version     "8.09"
#property description "Order Flow EA v8.09 — Production-Grade (Code Review Fixes Applied)"
#property strict

// [V8-18] Single source of truth for the EA version string.
#define EA_VERSION "8.09"
