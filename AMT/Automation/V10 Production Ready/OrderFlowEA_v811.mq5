//+------------------------------------------------------------------+
//|  OrderFlowEA_v811.mq5                                            |
//|  Order Flow EA — Production Grade v8.11                          |
//|                                                                    |
//|  v8.11 — March 2026 code-review patch (3 fixes applied).        |
//|  All v8.10 logic preserved; this release addresses:              |
//|                                                                    |
...
#property description "Order Flow EA v8.11 — Production-Grade (Code Review Fixes Applied)"
#property strict

// [V8-18] Single source of truth for the EA version string.
#define EA_VERSION "8.11"
