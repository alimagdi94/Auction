...
#property description "Order Flow EA v8.15 — Production-Grade (Code Review Fixes Applied)"
#property strict

// [V8-18] Single source of truth for the EA version string.
#define EA_VERSION "8.15"
...
void OnTradeTransaction(const MqlTradeTransaction &trans,
                        ...
                        const MqlTradeResult      &result)
  {
   ...
   // [V8-15] SL-SLASH-FORMAT: detect all common broker SL/TP comment formats.
   //    StringFind(commentTail,"sl") missed "s/l", "stop loss", "stop-loss".
   //    SL hits from these brokers fell through to the neutral branch, silently
   //    failing to increment g_consecutiveLosses. isTPHit receives a matching
   //    t/p expansion for symmetry.
