//+------------------------------------------------------------------+
//|  OrderFlowEA_v603.mq5                                            |
//|  Order Flow EA — Pure Trading Engine v6.03                        |
...
#property description "Order Flow EA v6.03 — Footprint signals + Automated Trading + Analysis Mode (pure)"
#property strict
