//+------------------------------------------------------------------+
//|  OrderFlowEA_v604.mq5                                            |
//|  Order Flow EA — Pure Trading Engine v6.04                        |
//|  No canvas, no UI objects — Journal + chart markers only          |
//|                                                                    |
//|  Production fixes from v6.03 (all bugs below caused the EA to    |
...
#property description "Order Flow EA v6.04 — Footprint signals + Automated Trading + Analysis Mode (pure)"
#property strict
...
int OnInit()
  {
   ...
   LogSystem(StringFormat(
      "OrderFlowEA v6.04 — Initialised | Symbol: %s | TickSize: %dpts x%d | Step: %spts"
