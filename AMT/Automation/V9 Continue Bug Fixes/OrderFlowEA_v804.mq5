//+------------------------------------------------------------------+
//|  OrderFlowEA_v804.mq5                                            |
//|  Order Flow EA — Production Grade v8.04                          |
//|                                                                    |
//|  v8.04 — March 2026 code-review patch (4 fixes applied).        |
//|  All v8.03 logic preserved; this release addresses:              |
//|                                                                    |
//|  [V8-19] QUICKSORT ASCENDING — ROOT CAUSE FIX (SORT-DIR)        |
//|    SortLevelsPartition() used >= pivot (descending Lomuto         |
//|    variant), producing levels[0]=HIGH, levels[len-1]=LOW.         |
...
#property description "Order Flow EA v8.04 — Production-Grade (Code Review Fixes Applied)"
#property strict

// [V8-18] Single source of truth for the EA version string.
#define EA_VERSION "8.04"
