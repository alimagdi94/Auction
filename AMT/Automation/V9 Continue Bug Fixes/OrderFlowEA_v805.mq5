//+------------------------------------------------------------------+
//|  OrderFlowEA_v805.mq5                                            |
//|  Order Flow EA — Production Grade v8.05                          |
//|                                                                    |
//|  v8.05 — March 2026 code-review patch (5 fixes applied).        |
...
#property version     "8.05"
#property description "Order Flow EA v8.05 — Production-Grade (Code Review Fixes Applied)"
#property strict

// [V8-18] Single source of truth for the EA version string.
#define EA_VERSION "8.05"
