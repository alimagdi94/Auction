...
#property description "Footprint Chart EA v5.22 — Full footprint + Discord + Automated Trading"
#property strict
...
ulong    g_Magic        = 20260226;  // unique EA magic number
         ...
         if(improvement)
           {
            ...
            double distEntry = MathAbs(curBid - beSL);
            if(pType == POSITION_TYPE_BUY)
               distEntry = MathAbs(curBid - beSL);
            else
               distEntry = MathAbs(curAsk - beSL);
