//+------------------------------------------------------------------+
//|  OrderFlowEA_v818.mq5                                            |
//|  Order Flow EA — Production Grade v8.18                          |
//|                                                                    |
//|  v8.18 — March 2026 code-review patch (5 fixes applied).        |
...
#property description "Order Flow EA v8.18 — Production-Grade (Code Review Fixes Applied)"
#property strict

// [V8-18] Single source of truth for the EA version string.
#define EA_VERSION "8.18"
